...
class SignUp extends Component {
  ...
  render() {
    let message;
    if (this.state.signUpfailMessage !== '') {
          message = <div className="signUpFailMessage">{this.state.signUpfailMessage}
                    </div>
        }
        else if (this.state.signUpSuccessMessage !== '') {
          message = <div className="signUpSuccessMessage">{this.state.signUpSuccessMessage}
                  </div>
        }
    return (
      <div>
